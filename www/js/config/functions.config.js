...
const FUNCTIONS_CONFIG = {
    'var13': {
        ...
        latex: 'x^4 + 4.81x^2 - 17.37x + 5.38',
        roots: {
            x1: { value: -7.291, y_value: 1, interval: [-9, -4], method: 'Хорд' },
            x2: { value: 0.345, y_value: 1, interval: [-4, 1.5], method: 'Ньютона' },
            x3: { value: 2.136, y_value: 1, interval: [1.5, 5], method: 'Простой итерации' }
        },
